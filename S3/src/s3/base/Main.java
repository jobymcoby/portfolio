...
import s3.ai.MapGeneration.MapMaker;
...
public class Main {
    ...
    public static String internalMain(String args[], int maxCycles) {
        ...
        MapMaker.main();
        if (map==null) map = "maps/chris.xml";

        if (map==null) map = "maps/ISLANDS1.xml";
        ...
        for (Object prop : propStrings) {
            ...
            pi.m_inputType = Integer.parseInt(splitStr[0]);
